...
function Row({title,movies}:Props) {
  ...
  return (
    <div className="h-40 space-y-0.5 md:space-y">
        ...
        <div className="group relative md:-ml-2">
            <ChevronLeftIcon className={`w-9 absolute top-0 bottom-0 left-2 z-40 m-auto h-9
            ...
            <ChevronRightIcon className={`w-9 absolute top-0 bottom-0 right-2 z-40 m-auto h-9
